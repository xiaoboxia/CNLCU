...
class mnist_dataset(Data.Dataset):
    def __init__(self, train=True, transform=None, target_transform=None, dataset='mnist', noise_type='symmetric', noise_rate=0.5, split_per=0.9, random_seed=1, num_class=10):
        ...
        self.train = train 
        original_images = np.load('/data/Henry/mnist_npy/mnist/train_images.npy')
        original_labels = np.load('/data/Henry/mnist_npy/mnist/train_labels.npy')
        ...
        # noise_or_not -> pure ratio calculations
        if self.train:
...
class mnist_test_dataset(Data.Dataset):
    def __init__(self, transform=None, target_transform=None):
        ...
        self.test_data = np.load('/data/Henry/mnist_npy/mnist/test_images.npy')
        self.test_labels = np.load('/data/Henry/mnist_npy/mnist/test_labels.npy') - 1 # 0-9
...
class cifar10_dataset(Data.Dataset):
    def __init__(self, train=True, transform=None, target_transform=None, dataset='cifar10', noise_type='symmetric', noise_rate=0.5, split_per=0.9, random_seed=1, num_class=10):
        ...
        original_images = np.load('/data/Henry/cifar10_npy/cifar10/train_images.npy')
        original_labels = np.load('/data/Henry/cifar10_npy/cifar10/train_labels.npy')
...
class cifar10_test_dataset(Data.Dataset):
    def __init__(self, transform=None, target_transform=None):
        ...
        self.test_data = np.load('/data/Henry/cifar10_npy/cifar10/test_images.npy')
        self.test_labels = np.load('/data/Henry/cifar10_npy/cifar10/test_labels.npy')
...
class svhn_dataset(Data.Dataset):
    def __init__(self, train=True, transform=None, target_transform=None, dataset='svhn', noise_type='symmetric', noise_rate=0.5, split_per=0.9, random_seed=1, num_class=10):
...
class cifar100_dataset(Data.Dataset):
    def __init__(self, train=True, transform=None, target_transform=None, dataset='cifar100', noise_type='symmetric', noise_rate=0.5, split_per=0.9, random_seed=1, num_class=100):
        ...
        original_images = np.load('/data/Henry/cifar100_npy/cifar100/train_images.npy')
        original_labels = np.load('/data/Henry/cifar100_npy/cifar100/train_labels.npy')
...
class cifar100_test_dataset(Data.Dataset):
    def __init__(self, transform=None, target_transform=None):
        ...
        self.test_data = np.load('/data/Henry/cifar100_npy/cifar100/test_images.npy')
        self.test_labels = np.load('/data/Henry/cifar100_npy/cifar100/test_labels.npy')
        self.test_data = self.test_data.reshape((-1, 3, 32, 32))
        self.test_data = self.test_data.transpose((0, 2, 3, 1)) 
...
class fmnist_dataset(Data.Dataset):
    def __init__(self, train=True, transform=None, target_transform=None, dataset='fmnist', noise_type='symmetric', noise_rate=0.5, split_per=0.9, random_seed=1, num_class=10):
        ...
        self.target_transform = target_transform
        self.train = train
        original_images = np.load('/data/Henry/fashion_mnist_npy/fashionmnist/train_images.npy').reshape((-1, 1, 28, 28))
        original_labels = np.load('/data/Henry/fashion_mnist_npy/fashionmnist/train_labels.npy')
...
class fmnist_test_dataset(Data.Dataset):
    def __init__(self, transform=None, target_transform=None):
        ...
        self.test_data = np.load('/data/Henry/fashion_mnist_npy/fashionmnist/test_images.npy').reshape((-1, 1, 28, 28))
        self.test_labels = np.load('/data/Henry/fashion_mnist_npy/fashionmnist/test_labels.npy')
